...
function _dropmenu(e) {
    _span = e.children, flag % 2 ? (_span[0].style.transform = "rotate(41deg)", _span[1].style.opacity = "0", _span[2].style.transform = "rotate(-41deg)", document.getElementById("mobile").style.height = _h + "px") : (_span[0].style.transform = "rotate(0deg)", _span[1].style.opacity = "1", _span[2].style.transform = "rotate(0deg)", document.getElementById("mobile").style.height = "0px"), flag++
}
